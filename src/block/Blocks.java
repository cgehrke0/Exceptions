...
public class Blocks {
	...
	// - In case of multiple non -static books , the block executes the order in which it is defined in the class
	...
	// - AA static blocks executes only once per classloader
	static {
